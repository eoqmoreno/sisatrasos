    ...
    <body class="bg-branco">
        ...
        <div class="container col-md-4 border-laranja border-radius pt-3 pb-2 pr-5 pl-5 mt-5 text-center">
            ...
            <form action="buscarAluno.php" class="m-0 p-0 mt-2" method="post">
                <input class="form-control helveticalg" required type="text" name="sige" placeholder="Número do SIGE">
                <input type="submit" value="PROCURAR" class="btn float-right mt-1 text-bold laranja border-laranja bg-branco procurar pointer helveticalg"><br><br>
            </form>
        </div>
</body>
</html>