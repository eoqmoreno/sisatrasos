...
<ul class="list-inline text-center bg-cinza pt-1 pb-1">			 
            ...
            <li class="list-inline-item"><a class="laranja" target="_blank" data-toggle="collapse" href="#atualizar" aria-expanded="false" aria-controls="collapseExample">Atualizar Senha</a></li>
        ...
        <script src="./ajax.js"></script>
        	...
        	<br>
                        <select name="curso" class="form-control mb-2" required onchange="mostraConteudo('../apontador/buscar.php?curso='+document.busca.curso.value+'&serie='+document.busca.serio.value,'resultado_busca')">
        ...
        <div class="collapse" id="atualizar">
                <div class="container col-md-4 border-laranja border-radius text-center">
                <label class="text-quarenta helveticalg">Atualizar Senha</label> 
                <form method="POST" action="atualizar_senha.php">
                <input type="password" required class="form-control mb-2" name="antiga" placeholder="Senha Antiga"/>
                <input type="password" required class="form-control mb-2" name="nova" placeholder="Nova Senha"/>
                <input type="password" required class="form-control mb-2" name="conf" placeholder="Confirme Senha"/>
                <input type="submit" class="btn float-right text-bold laranja border-laranja bg-branco procurar pointer">
                <input type="reset" class="btn float-right text-bold laranja border-laranja bg-branco procurar pointer">
                <br>
                </form>
